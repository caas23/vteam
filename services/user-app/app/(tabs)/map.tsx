...
import { Image, StyleSheet, View, Text, TouchableOpacity, FlatList, Modal, TouchableWithoutFeedback, Animated, ActivityIndicator } from 'react-native';
...
const MapTab: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {isDropdownVisible && (
        <Modal transparent visible animationType="fade" onRequestClose={() => setDropdownVisible(false)}>
